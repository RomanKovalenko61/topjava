...
public class UserMealsUtil {
    ...
    public static List<UserMealWithExcess> filteredByCycles(List<UserMeal> meals, LocalTime startTime, LocalTime endTime, int caloriesPerDay) {
        ...
        List<UserMealWithExcess> listMealsWithExcess = new ArrayList<>();
        for (UserMeal meal : filteredMeals) {
            listMealsWithExcess.add(new UserMealWithExcess(meal.getDateTime(),
                    meal.getDescription(),
                    meal.getCalories(),
                    caloriesPerDays.get(meal.getDateTime().toLocalDate()) >= caloriesPerDay));
        }
        listMealsWithExcess.sort(Comparator.comparing(UserMealWithExcess::getDateTime));
        return listMealsWithExcess;
    }
